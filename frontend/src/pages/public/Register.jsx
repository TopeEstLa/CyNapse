    ...
    <div className="max-w-2xl mx-auto py-12 px-4 animate-fade-in">
      <div className="bg-white p-8 md:p-12 rounded-[2.5rem] border border-gray-100 shadow-2xl shadow-blue-600/5">
        <div className="flex flex-col items-center mb-10">
          ...
          <h2 className="text-3xl font-black text-gray-900 tracking-tighter uppercase text-center">Join the Ecosystem</h2>
            ...
            <div className="flex flex-wrap gap-4 px-2">
              {['Homme', 'Femme', 'Autre'].map((g) => (
                <label key={g} className="flex items-center gap-2 cursor-pointer group">
                  ...
                  />
                  <span className="text-sm font-bold text-gray-600 group-hover:text-blue-600 transition-colors">{g}</span>
                </label>
              ))}
            </div>
          </div>
