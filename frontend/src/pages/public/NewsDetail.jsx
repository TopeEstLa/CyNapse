...
const NewsDetail = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-6 md:py-12 px-4 animate-fade-in">
      ...
      <article className="bg-white p-6 md:p-12 rounded-[2.5rem] border border-gray-100 shadow-xl shadow-blue-600/5">
        <header className="mb-10 border-b border-gray-50 pb-8">
          ...
          <div className="flex items-center gap-3">
             <div className="h-8 w-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-black text-[10px] border border-blue-200 uppercase">
                {news.author[0]}
             </div>
