        ...
        <div className="space-y-8 py-8">
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center py-20">
                    <div
                        className="animate-spin rounded-full h-10 w-10 border-t-2 border-b-2 border-blue-600 mb-4"></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                    {filteredNews.map((news) => (
                        <div key={news.id}
                             className="group bg-white p-6 md:p-8 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-xl hover:border-blue-100 transition-all duration-300 flex flex-col justify-between">
                            <div>
