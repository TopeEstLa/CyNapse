...
const AdminDashboard = () => {
  ...
  const statCards = [
    ...
    { label: 'Active Users', value: stats.active, icon: UserCheck, color: 'bg-green-500' },
    { label: 'Pending', value: stats.pending, icon: UserPlus, color: 'bg-amber-500' },
        ...
        <div className="bg-white p-6 md:p-8 rounded-[2rem] border border-gray-100 shadow-sm">
           ...
           <div className="space-y-4">
             <div className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl">
                ...
                <span className="text-[10px] font-black text-green-600 uppercase">Protected</span>
             </div>
             <div className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl">
                <div className="flex items-center gap-3">
                ...
                <span className="text-[10px] font-black text-blue-600 uppercase">Viewable</span>
             </div>
           </div>
        </div>
