...
const AdminPendingUsers = () => {
  ...
  return (
    <main className="space-y-6 text-gray-900">
      ...
      {users.length === 0 ? (
        <section className="bg-gray-50 rounded-xl border-2 border-dashed border-gray-200 py-20 text-center text-gray-400">
            ...
            <table className="w-full text-left border-collapse min-w-[700px]">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  ...
                  <th className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">Registration Info</th>
                  ...
                  <tr key={u.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded bg-yellow-50 flex items-center justify-center flex-shrink-0 border border-yellow-100 overflow-hidden">
                          {u.image ? <img src={u.image} alt="" className="w-full h-full object-cover" /> : <User className="w-5 h-5 text-yellow-600" />}
                        </div>
