...
import {AlertCircle, ArrowLeft, CheckCircle2, Loader2, Lock, Save, User} from 'lucide-react';
import {MemberType, Role} from '../../../utils/constants.js';
    ...
    return (
        <main className="max-w-4xl mx-auto p-4 text-gray-900">
            ...
            <header className="flex items-center gap-4 mb-8 border-b pb-6">
                <div
                    className="w-16 h-16 rounded-lg bg-gray-100 flex items-center justify-center overflow-hidden border border-gray-200">
                    {user.image ? (
            ...
            {error && (
                <div
                    className="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-lg flex items-center gap-2 mb-6">
            ...
            {success && (
                <div
                    className="bg-green-50 border border-green-200 text-green-600 px-4 py-3 rounded-lg flex items-center gap-2 mb-6">
                    ...
                    <div className="bg-white p-6 md:p-8 rounded-lg border border-gray-200 shadow-sm">
                        ...
                        <form onSubmit={handleUpdateUser} className="space-y-4">
                            ...
                            <div className="flex items-center gap-2 pt-2">
                                ...
                                />
                                <label htmlFor="enable" className="text-sm font-bold text-gray-700">Account
                                    Active</label>
                            </div>
