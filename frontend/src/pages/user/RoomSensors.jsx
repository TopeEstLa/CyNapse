...
import {BASE_URL, deviceApi, roomApi} from '../../utils/api';
import {
  Activity,
  ArrowLeft,
  ArrowRight,
        ...
        <main className="max-w-7xl mx-auto px-4 py-6 md:py-8 space-y-8 text-gray-900">
            ...
            <section className="bg-gray-900 rounded-xl p-8 text-white relative overflow-hidden shadow-lg">
                <div className="relative z-10 space-y-4">
                    <div
                        className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 rounded-full text-xs font-semibold uppercase tracking-wider">
            ...
            <section className="space-y-6">
                ...
                {successMessage && (
                    <div
                        className="bg-green-50 border border-green-200 p-4 rounded-lg flex items-center gap-3 text-green-700 text-sm font-medium">
                            ...
                            <div key={device.id} className="relative group">
                                ...
                                >
                                    <div className="flex justify-between items-start mb-6">
                                        ...
                                        <span
                                            className={`px-2 py-1 rounded text-[10px] font-bold text-white uppercase ${getStatusColor(device.status)}`}>
                      {device.status}
                    </span>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <span
                                                    className="text-2xl font-bold text-gray-900">{formatValue(device)}</span>
                                            </div>
                                            {device.electricityConsumption !== undefined && (
                                                <div className="text-right">
                                                    <span
                                                        className="text-[10px] font-bold text-gray-400 uppercase">Power</span>
                                        ...
                                        <div
                                            className="pt-4 border-t border-gray-100 flex items-center justify-between text-[10px] font-bold text-gray-400 uppercase">
                                            <div className="flex items-center gap-2">
                                                <Clock className="w-3.5 h-3.5"/>
                                                <span>{device.lastSeenAt ? new Date(device.lastSeenAt).toLocaleTimeString() : 'N/A'}</span>
                                            </div>
                                            <ArrowRight
                                                className="w-4 h-4 text-gray-300 group-hover:text-blue-600 group-hover:translate-x-1 transition-all"/>
                                        </div>
                                    </div>
                                </button>
                    ...
                    {actuators && actuators.map(device => {
                      ...
                      {device.status}
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div
                                            className="bg-blue-50 rounded-lg p-4 flex items-center justify-between border border-blue-100">
                                            <div className="flex flex-col">
                                                <span
                                                    className="text-[10px] font-bold text-blue-400 uppercase">State</span>
                                                <span
                                                    className="text-2xl font-bold text-blue-600 uppercase">{device.currentState || 'OFF'}</span>
                                            </div>
                                            {device.electricityConsumption !== undefined && (
                                                <div className="text-right">
                                                    <span
                                                        className="text-[10px] font-bold text-blue-400 uppercase">Power</span>
                                                    <div className="flex items-center gap-1 text-yellow-600 font-bold">
                                                        <Zap className="w-3 h-3"/>
                                                        <span>{device.electricityConsumption}W</span>
                                                    </div>
                                        ...
                                        <div
                                            ...
                                            <ArrowRight
                                                className="w-4 h-4 text-gray-200 group-hover:text-blue-600 group-hover:translate-x-1 transition-all"/>
                                        </div>
                                    </div>
                                </button>
