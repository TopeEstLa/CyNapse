    ...
    return (
        <main className="max-w-4xl mx-auto p-4 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <header
                    className="h-24 md:h-28 bg-gray-50 flex items-center px-4 md:px-8 justify-between border-b relative">
                    <div
                        className="w-16 h-16 md:w-20 md:h-20 rounded-lg bg-white shadow-sm flex items-center justify-center border-2 border-gray-200 translate-y-8 md:translate-y-10 overflow-hidden">
                        {user.image ? (
                ...
                <div className="pt-12 md:pt-16 px-4 md:px-8 pb-8">
                    {isEditing ? (
                        <form onSubmit={handleProfileUpdate} className="space-y-6">
                            ...
                            <div
                                className="p-4 bg-blue-50 border border-blue-100 rounded-lg flex flex-col sm:flex-row items-center gap-4">
                        ...
                        <section>
                            <div
                                className="flex flex-col sm:flex-row justify-between items-start border-b pb-6 mb-6 gap-6">
                                <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                                <div
                                    className="flex items-center gap-4 p-3 md:p-4 bg-gray-50 rounded-lg border border-gray-100">
                                ...
                                <div
                                    ...
                                    <div>
                                        <p className="text-[10px] text-gray-500 font-semibold uppercase tracking-wider">Birth
                                            Date</p>
                                ...
                                <div
                                    ...
                                    <div>
                                        <p className="text-[10px] text-gray-500 font-semibold uppercase tracking-wider">Member
                                            Type</p>
