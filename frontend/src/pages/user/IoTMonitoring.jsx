...
import {ArrowRight, Layers, Loader2, RefreshCcw, ShieldCheck, Users} from 'lucide-react';
import {useNavigate} from 'react-router-dom';
import {useAuth} from '../../context/AuthContext';
import {Role, RoomStatus} from '../../utils/constants';
          ...
          <span className="text-[10px] text-gray-400 font-bold uppercase">
            ...
            {overview && (
                <section className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div
                        className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm border-l-4 border-l-blue-500">
