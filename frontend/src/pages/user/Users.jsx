    ...
    return (
        <main className="max-w-6xl mx-auto p-4 space-y-8">
            ...
            <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                {filteredUsers.map((u) => (
                    ...
                    >
                        <div className="flex flex-col items-center text-center">
                            <div
                                className="w-16 h-16 md:w-20 md:h-20 rounded-lg bg-gray-100 flex items-center justify-center mb-3 md:mb-4 overflow-hidden border border-gray-200">
                                {u.image ? (
                ...
                <span
                    className="text-[8px] md:text-[10px] font-bold uppercase tracking-wider text-blue-600 bg-blue-50 px-1.5 md:px-2 py-0.5 rounded border border-blue-100">
                  {u.role || 'USER'}
                </span>
